				...
				<div>
					<ul class="shopping-info gray-box">
						<li class="online-services" >
							<span class="online"><img src="/static/img/pc/icon01.png"/></span>
							<h5>在线客服</h5>
							<h6>周一至周日 9:00-18:00</h6></li>
						<li class="online-services" >
							<span class="online"><img src="/static/img/pc/icon02.png"/></span>
							<h5>7 天无理由退货</h5>
							<h6>7 天无理由退货 请放心购买</h6></li>
						<li class="online-services" >
							<span class="online"><img src="/static/img/pc/icon03.png"/></span>
							<h5>15 天免费换货</h5>
							<h6>15 天内如遇质量问题 免费换货</h6></li>
						<li class="online-services" >
							<span class="online"><img src="/static/img/pc/icon04.png"/></span>
