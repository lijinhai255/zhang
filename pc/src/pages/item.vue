		...
		<div class="item-box">
			<div class="gallery-wrapper">
				<div class="gallery">
					<div class="thumbnail">
						<ul>
							<li :class="{'on':index === imgIndex}" @click="tableImg(index)" v-for="(image, index) in itemInfo.ali_images" :key="index">
					...
					<div class="thumb">
						<ul>
							<li :class="{'on':index === imgIndex}" v-for="(image, index) in itemInfo.ali_images" :key="index">
			...
			<div class="banner">
				...
				<div class="sku-status">
					<div class="cart-operation-wrapper clearfix">
						<span class="blue-title-btn js-add-cart"><a @click="addCarpanelData">加入购物车</a></span>
