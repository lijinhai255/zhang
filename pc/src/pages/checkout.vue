				...
				<div class="box-inner js-checkout-address-panel " >
					<div class="address-common-table js-multiple-address-panel" >
						<ul class="address-item-list clear js-address-item-list">
							...
							<li class="js-choose-address" :class="{'selected-address-item' : receiveIndex == index}" v-for="(item, index) in receiveInfo" @click="chooseRecevice(index)">
				...
				<div class="invoice-detail"> 发票抬头： 
					<div class="radio-box"> 
						<label> 
							...
							<span class="blue-radio" @click="checkedInvoice(true)" :class="{'blue-radio-on':incoice.prosonal}"><a></a></span>  个人
						</label> 
						<label> 
							<input type="radio"  @click="checkedInvoice(false)" class="hide" :class="{'blue-radio-on':incoice.prosonal}" > 
							<span class="blue-radio"><a></a></span>  单位
						</label> 
					</div> 
					<div class="module-form-row form-item fn-hide js-invoice-title" v-if="!incoice.prosonal"> 
						<div class="module-form-item-wrapper no-icon small-item"> 
							...
							<div class="verify-error" v-show="!incoice.name">必填</div>
						</div> 
					</div> 
				</div> 
		...
		<div class="gray-box">
			...
			<div class="box-inner"> 
				<div class="last-payment clear"> 
					<span @click="submitOther " class="jianguo-blue-main-btn big-main-btn payment-blue-bt fn-right js-checkout">
					 <a>提交订单</a> 
					</span> 
