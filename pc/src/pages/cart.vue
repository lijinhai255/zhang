							...
							<div class="cart-top-items" v-for="(item, index) in carPanelData" :key="index">
								<div class="cart-items">
									...
									<div class="items-choose">
										<!-- checkbox-on -->
										<span class="blue-checkbox-new" @click="checkGoods(item.sku_id)" :class="{'checkbox-on' : item.check}">
											<a></a>
										</span>
									</div>
									<div class="items-thumb">
										<!-- <img src="/static/pc/img/goods/s1.jpg"> -->
										<img :src="item.ali_image + '?x-oss-process=image/resize,w_206/quality,Q_80/format,webp'">
										<a href="javascript:;" target="_blank"></a>
									</div>
									<div class="name hide-row" >
										<div class="name-table">
											<a href="javascript:;" target="_blank">{{item.title}}--{{item.check}}</a>
											<ul class="attribute">
				...
				<div class="cart-bar-operation">
					<div>
						<div class="choose-all js-choose-all">
							...
							<span class="blue-checkbox-new" @click="allCheckGoods(allChecked)" :class="{'checkbox-on' : allChecked}">
								<a></a>
							</span>
							全选
						</div>
						<div class="delete-choose-goods" @click="delChecGoods(allChecked)">删除选中的商品</div>
					</div>
				</div>
				<div class="shipping">
